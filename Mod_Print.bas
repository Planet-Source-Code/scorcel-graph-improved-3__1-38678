...
Public Sub ChngPrinterOrientationPortrait(ByVal frm As Form)
    ...
    Call SetOrientation(DMDUP_SIMPLEX, PageDirection, frm)
End Sub
Public Function ChngPrinterOrientation(ByVal frm As Form, PDirection As Integer) As Boolean
On Error GoTo ERR
    Call SetOrientation(DMDUP_SIMPLEX, PDirection, frm)
    ChngPrinterOrientation = True
Exit Function
ERR:
ChngPrinterOrientation = False
End Function
